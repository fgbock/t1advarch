...
mm_combo.exe:
	$(COMPILER) -O0 -o $(BIN)/mm_combo.exe $(SRC)/mm_combo.c
	
mm_combo_duff.exe:
	$(COMPILER) -O0 -o $(BIN)/mm_combo_duff.exe $(SRC)/mm_combo_duff.c

mm_simd.exe:
	$(COMPILER) -O0 -march=native -o $(BIN)/mm_simd.exe $(SRC)/mm_simd.c
